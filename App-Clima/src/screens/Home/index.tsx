      ...
      <View style={styles.content}>
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <Text style={styles.headerLeftText}>Niterói, RJ</Text>
        ...
        <View style={styles.info}>
          ...
          <Text style={styles.infoTextMaxMin}>Max.: 29º Min.: 20º</Text>
        </View>
      </View>
      <View style={styles.infoDetails}>
        <Text style={styles.infoDetailsText}>Previsão dos próximos 4 dias</Text>
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          <View style={styles.infoDetailsCard}>
            <Text style={styles.infoDetailsCardWeekDay}>Sáb.</Text>
            <Sun02d width={40} height={40} />
            <Text style={styles.infoDetailsCardPreview}>28°C</Text>
          </View>

          <View style={styles.infoDetailsCard}>
            <Text style={styles.infoDetailsCardWeekDay}>Dom.</Text>
            <Sun02d width={40} height={40} />
            <Text style={styles.infoDetailsCardPreview}>25°C</Text>
          </View>

          <View style={styles.infoDetailsCard}>
            <Text style={styles.infoDetailsCardWeekDay}>Seg.</Text>
            <Sun02d width={40} height={40} />
            <Text style={styles.infoDetailsCardPreview}>27°C</Text>
          </View>

          <View style={styles.infoDetailsCard}>
            <Text style={styles.infoDetailsCardWeekDay}>Ter.</Text>
            <Sun02d width={40} height={40} />
            <Text style={styles.infoDetailsCardPreview}>29°C</Text>
          </View>
        </ScrollView>
      </View>
    </LinearGradient>
